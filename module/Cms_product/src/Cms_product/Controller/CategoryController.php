...
use Cms_product\Form\CMSCategory as theForm;
use Cms_product\Model\Entity\CMSCategory as theEntity;
...
class CategoryController extends AbstractActionController
{
    ...
    private function init()
    {
        ...
        $this->workTable = $sm->get('Cms_product\Model\CMSCategoryTable');
        $this->template = require_once PRODUCT_MODULE_ROOT . '/config/category_type.php';
        $this->sideWidget = "This is sidewidget";
        $this->seoTable = $sm->get('Cms_core\Model\SEOTable');
        $this->seoType = 'category';
        
        $this->cms_url_base = "/admin/category";
        $this->base_route = "cms_category";
    }
    ...
    public function editAction()
    {
        ...
        if(file_exists(PRODUCT_MODULE_ROOT . "/config/template/cat_{$theRecord->type}.php"))
            $arrExtraFields = require_once PRODUCT_MODULE_ROOT . "/config/template/cat_{$theRecord->type}.php";
        ...
        $form->get('parent_id')->setAttribute('options', $this->workTable->getParentCategoryList());
